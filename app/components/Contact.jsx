                ...
                <div className="space-y-6">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">+91 78060 81661</p>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">info@skaprojects.in</p>
                    </div>
                  </motion.div>
                </div>
              </div>
            ...
            >
              ...
              <form className="space-y-6">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="w-full bg-yellow-500 text-black font-semibold py-4 rounded-lg hover:bg-yellow-400 transition-colors"
                >
                  Send Message
                </motion.button>
              </form>
          ...
          >
            <div className="bg-yellow-500 rounded-2xl p-8 lg:p-12 max-w-4xl mx-auto">
              <h3 className="text-2xl md:text-3xl font-bold text-black mb-4">
                Belief. Stronger Than Steel.
              </h3>
              <p className="text-lg text-black/80">
                Let's build the future together with quality, reliability, and innovation.
              </p>
            </div>
          </motion.div>
        </div>
